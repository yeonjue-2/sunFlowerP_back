...
## 리팩토링
- 객체를 생성할 때 디자인 패턴 적용
  - 비즈니스 로직에서 Dto를 생성하는 코드의 가독성을 높이기 위해 사용
  - 정적 팩토리 메서드 패턴 : 호출 할 때마다 새로운 객체를 생성할 필요가 없다는 장점이 있음
  - 빌더 패턴 : 유연성과 가독성이 좋음

   -> 생성될 Dto 객체 내의 정적 팩토리 메서드에서 빌더 패턴을 사용
  </p>
  </p>
  <img width="582" alt="스크린샷 2023-08-05 오후 5 57 58" src="https://github.com/yeonjue-2/sunFlowerP_back/assets/101540771/8b535805-ebab-4d7f-a66a-5cda8751e939"> </p>
  <img width="355" alt="스크린샷 2023-08-05 오후 5 58 08" src="https://github.com/yeonjue-2/sunFlowerP_back/assets/101540771/b128cc81-e080-4fa7-9381-0e01599c054c">
